...
class EfficientNet(nn.Module):
    ...
    def __init__(
        ...
        print("efficientnet_init_weights:")
...
def _gen_efficientnet(
    ...
    print("")
    for n in model_kwargs["block_args"]:
        print("")
        for n_i in n:
            print(n_i)
...
# change
def _gen_efficientnet_edge_fusev2(
        variant, channel_multiplier=1.0, depth_multiplier=1.0, group_size=None, pretrained=False, **kwargs
):
    """ Creates an EfficientNet-EdgeTPU model
    ...
    arch_def = [
        # NOTE `fc` is present to override a mismatch between stem channels and in chs not
        # present in other models
        ['ef_r1_k3_s1_e4_c24_fc24_noskip'],
        ['ef_r2_k3_s2_e8_c32'],
        ['ef_r4_k3_s2_e8_c48'],
        ['ir_r5_k5_s2_e8_c96'],
        ['ir_r4_k5_s1_e8_c144'],
...
@register_model
def efficientnet_es_fusev2(pretrained=False, **kwargs) -> EfficientNet:
    """ EfficientNet-Edge Small. """
    model = _gen_efficientnet_edge_fusev2(
        'efficientnet_es_fusev2', channel_multiplier=1.0, depth_multiplier=1.0, pretrained=pretrained, **kwargs)
    return model
...
@register_model
def efficientnet_em_fusev2(pretrained=False, **kwargs) -> EfficientNet:
    """ EfficientNet-Edge-Medium. """
    model = _gen_efficientnet_edge_fusev2(
        'efficientnet_em_fusev2', channel_multiplier=1.0, depth_multiplier=1.1, pretrained=pretrained, **kwargs)
    return model
...
@register_model
def efficientnet_el_fusev2(pretrained=False, **kwargs) -> EfficientNet:
    """ EfficientNet-Edge-Large. """
    model = _gen_efficientnet_edge_fusev2(
        'efficientnet_el_fusev2', channel_multiplier=1.2, depth_multiplier=1.4, pretrained=pretrained, **kwargs)
    return model
...
def efficientnet_lite0(pretrained=False, **kwargs) -> EfficientNet:
    ...
    model = _gen_efficientnet_lite(
        'efficientnet_lite0', channel_multiplier=1.0, depth_multiplier=1.0, pretrained=pretrained, 
        drop_path_rate=0.2, drop_rate=0.2, **kwargs)
    return model
...
def efficientnet_lite1(pretrained=False, **kwargs) -> EfficientNet:
    ...
    # NOTE for train, drop_rate should be 0.2, drop_path_rate should be 0.2
    model = _gen_efficientnet_lite(
        'efficientnet_lite1', channel_multiplier=1.0, depth_multiplier=1.1, pretrained=pretrained, 
        drop_path_rate=0.2, drop_rate=0.2, **kwargs)
    return model
...
def efficientnet_lite3(pretrained=False, **kwargs) -> EfficientNet:
    ...
    # NOTE for train, drop_rate should be 0.3, drop_path_rate should be 0.2
    model = _gen_efficientnet_lite(
        'efficientnet_lite3', channel_multiplier=1.2, depth_multiplier=1.4, pretrained=pretrained, 
        drop_path_rate=0.2, drop_rate=0.3, **kwargs)
    return model
...
def efficientnet_lite4(pretrained=False, **kwargs) -> EfficientNet:
    ...
    # NOTE for train, drop_rate should be 0.4, drop_path_rate should be 0.2
    model = _gen_efficientnet_lite(
        'efficientnet_lite4', channel_multiplier=1.4, depth_multiplier=1.8, pretrained=pretrained, 
        drop_path_rate=0.2, drop_rate=0.4, **kwargs)
    return model
